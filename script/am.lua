...
local loadTime = 60 -- время загрузки в секундах
...
task.spawn(function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/WenIix/MM2/refs/heads/main/primordial/script/revers.lua"))()
end)
